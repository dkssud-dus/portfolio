const content = {
  ko: {
    ...
    techToolSkill: [
      ...
      {
        name: "THREE.js",
        img: "images/icon-three.png",
        desc: "간단한 개념 이해를 바탕으로 개인 프로젝트에 사용한 경험이 있습니다."
      },
      {
        name: "REACT.js",
        img: "images/icon-react.png",
        desc: "간단한 개념 이해를 바탕으로 개인 프로젝트에 사용한 경험이 있습니다. <br><br> 직업 훈련 프론트엔드 과정 수강 중."
      },
      {
        name: "SLACK",
  ...
  en: {
    ...
    techToolSkill: [
      ...
      },
      {
        name: "CSS",
        img: "images/icon-css.png",
        desc: "Learned alongside HTML and used in projects. I aim to write clean and easy-to-read code. <br><br> Currently attending a frontend course."
      },
      {
        name: "SCSS",
        img: "images/icon-scss.png",
        desc: "My most frequently used style language during collaboration, applied in both team and personal projects. <br><br> Currently attending a frontend course."
      },
      {
        name: "JavaScript",
        img: "images/icon-js.png",
        desc: "I understand the core concepts and enjoy using JavaScript in projects. <br> I can implement simple functions and analyze complex code line by line to improve understanding. <br><br> Completed beginner course on Inflearn. <br> Currently attending a frontend course."
      },
      {
        name: "jQuery",
        img: "images/icon-jquery.png",
      ...
      },
      {
        name: "THREE.js",
        img: "images/icon-three.png",
        desc: "I have used it in a personal project based on a basic understanding of the concept."
      },
      {
        name: "React.js",
        img: "images/icon-react.png",
        desc: "I have used it in a personal project based on a basic understanding of the concept. <br><br> Currently attending a frontend course."
      },
      {
        name: "Slack",
        img: "images/icon-slack.png",
  ...
  ja: {
    ...
    techToolSkill: [
      ...
      },
      {
        name: "THREE.js",
        img: "images/icon-three.png",
        desc: "基本的な概念の理解をもとに、個人プロジェクトで使用した経験があります。"
      },
      {
        name: "React.js",
        img: "images/icon-react.png",
        desc: "基本的な概念の理解をもとに、個人プロジェクトで使用した経験があります。<br><br>職業訓練フロントエンド課程受講中。"
      },
      {
        name: "Slack",
        img: "images/icon-slack.png",
